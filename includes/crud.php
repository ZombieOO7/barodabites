...
/* note: don't forget to add forward slash '/' at the end the DOMAIN_URL */
define('DOMAIN_URL','https://www.barodabites.com/cart/'); /* change to your domain here */
...
class Database{
    ...
    private $db_user = "baroxghp_cart";  // Change as required
    private $db_pass = "deepak@123";  // Change as required
    private $db_name = "baroxghp_cart";    // Change as required
